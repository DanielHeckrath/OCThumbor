...
#define oct_brightness(amount)                              [OCThumborURLBuilder brightnessFilter:amount]
#define oct_contrast(amount)                                [OCThumborURLBuilder contrastFilter:amount]
#define oct_noise(amount)                                   [OCThumborURLBuilder noiseFilter:amount]
#define oct_quality(amount)                                 [OCThumborURLBuilder qualityFilter:amount]
#define oct_rgb(red,green,blue)                             [OCThumborURLBuilder colorFilterWithRed:red withGreen:green andBlue:blue]
#define oct_roundCorner(radius)                             [OCThumborURLBuilder roundCornerFilter:radius]
#define oct_roundCornerC(radius,color)                      [OCThumborURLBuilder roundCornerFilter:radius withColor:color]
#define oct_roundCornerOC(radius,outerRadius,color)         [OCThumborURLBuilder roundCornerFilter:radius withOuterRadius:outerRadius andColor:color]
#define oct_watermark(image)                                [OCThumborURLBuilder watermarkFilter:image]
#define oct_watermarkXY(image,x,y)                          [OCThumborURLBuilder watermarkFilter:image withX:x andY:y]
#define oct_watermarkXYA(image,x,y,transparency)            [OCThumborURLBuilder watermarkFilter:image withX:x withY:y andTransparency:transparency]
#define oct_watermarkB(builder)                             [OCThumborURLBuilder watermarkFilterWithBuilder:builder]
#define oct_watermarkBXY(builder,x,y)                       [OCThumborURLBuilder watermarkFilterWithBuilder:builder withX:x andY:y]
#define oct_watermarkBXYA(builder,x,y,transparency)         [OCThumborURLBuilder watermarkFilterWithBuilder:builder withX:x withY:y andTransparency:transparency]
#define oct_sharpen(amount,radius,luminancyOnly)            [OCThumborURLBuilder sharpenFilter:amount withRadius:radius andLuminanceOnly:luminancyOnly]
#define oct_fill(color)                                     [OCThumborURLBuilder fillFilter:color]
#define oct_format(image)                                   [OCThumborURLBuilder formatFilter:image]
#define oct_frame(image)                                    [OCThumborURLBuilder frameFilter:image]
#define oct_stripicc                                        [OCThumborURLBuilder stripiccFilter]
#define oct_grayscale                                       [OCThumborURLBuilder grayscaleFilter]
#define oct_equalize                                        [OCThumborURLBuilder equalizeFilter]